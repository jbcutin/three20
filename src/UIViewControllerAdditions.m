...
- (void)setResponsibleNavigator:(TTNavigator*)navigator {
  ...
  if ([self respondsToSelector:@selector(setResponsibleNavigatorSideEffects:)]) {
    [self performSelector:@selector(setResponsibleNavigatorSideEffects:) withObject:navigator];
  }
}
