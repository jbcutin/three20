...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation StyledViewsViewController
...
- (void)loadView {
  ...
  _scrollView.backgroundColor = RGBCOLOR(216, 221, 231);
  ...
  CGFloat padding = 10;
  CGFloat viewWidth = _scrollView.width/2 - padding*2;
  CGFloat viewHeight = TT_ROW_HEIGHT;
  
  CGFloat x = padding;
  CGFloat y = padding;
  for (TTStyle* style in styles) {
    if (x + viewWidth >= _scrollView.width) {
      x = padding;
  ...
  _scrollView.contentSize = CGSizeMake(_scrollView.width, y + viewHeight + padding);
}
...
- (void)viewWillAppear:(BOOL)animated {
  ...
  _scrollView.contentSize = CGSizeMake(self.view.width, _scrollView.contentSize.height);
}
